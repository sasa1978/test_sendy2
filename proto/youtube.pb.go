...
var file_youtube_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x79, 0x6f, 0x75, 0x74, 0x75, 0x62, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x05, 0x74, 0x65, 0x73, 0x74, 0x31, 0x22, 0x23, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x65, 0x32, 0x39, 0x0a, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x2d, 0x0a,
	0x08, 0x50, 0x6c, 0x61, 0x79, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x0e, 0x2e, 0x74, 0x65, 0x73, 0x74,
	0x31, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x74, 0x65, 0x73, 0x74,
	0x31, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b,
	0x74, 0x65, 0x73, 0x74, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_youtube_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: test1.Request
	(*Response)(nil), // 1: test1.Response
}
var file_youtube_proto_depIdxs = []int32{
	0, // 0: test1.playlist.Playlist:input_type -> test1.Request
	1, // 1: test1.playlist.Playlist:output_type -> test1.Response
...
type PlaylistClient interface {
	Playlist(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *playlistClient) Playlist(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/test1.playlist/Playlist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlaylistServer interface {
	Playlist(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedPlaylistServer) Playlist(context.Context, *Request) (*Response, error) {
...
func _Playlist_Playlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlaylistServer).Playlist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test1.playlist/Playlist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistServer).Playlist(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _Playlist_serviceDesc = grpc.ServiceDesc{
	ServiceName: "test1.playlist",
	HandlerType: (*PlaylistServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Playlist",
			Handler:    _Playlist_Playlist_Handler,
		},
	},
